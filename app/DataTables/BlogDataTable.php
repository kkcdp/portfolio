...
class BlogDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->rawColumns(['image', 'action']) //to render interpreted html code (img), not just a plain code
            ->setRowId('id');
    }
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
                    ...
                    ->minifiedAjax()
                    ->orderBy(0) //Ordering by "column number" 0=first column, id, desc!
                    ->selectStyleSingle()
                    ->buttons([
                        Button::make('excel'),
                        Button::make('csv'),
    ...
    public function getColumns(): array
    {
        return [            
            ...
            Column::make('image')->width(160),
            Column::make('title')->width(160),
            Column::make('category')->width(160),
